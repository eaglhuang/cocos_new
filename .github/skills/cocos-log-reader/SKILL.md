...
<!-- 此檔案為 .agents/skills/cocos-log-reader/SKILL.md (doc_agentskill_0003) 的鏡像副本，供 GitHub Copilot 技能載入使用 -->
...
# 過濾 GeneralDetail 相關
Get-Content "c:\Users\User\3KLife\temp\logs\project.log" -Tail 400 -Encoding UTF8 |
  Where-Object { $_ -match "GeneralDetailPanel|GeneralDetailComposite" } | Select-Object -Last 20
```

## 完整 SOP

請讀取主技能檔案以取得完整步驟：  
`.agents/skills/cocos-log-reader/SKILL.md` (doc_agentskill_0003)
