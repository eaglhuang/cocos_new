...
> 狀態註記：本補遺已將重要結論回寫至正式母規格，後續以 [武將人物介面規格書.md](C:/Users/User/3KLife/docs/系統規格書/武將人物介面規格書.md)、[UI 規格書.md](C:/Users/User/3KLife/docs/UI 規格書.md) 與 [cross-reference-index.md](C:/Users/User/3KLife/docs/cross-reference-index.md) 為準。本檔僅保留為過程記錄與比對參考，不再作為單一真相來源。

## 對應任務

- [UI-2-0059](C:\Users\User\3KLife\docs\agent-briefs\tasks\UI-2-0059.md)
- [UI-2-0060](C:\Users\User\3KLife\docs\agent-briefs\tasks\UI-2-0060.md)
