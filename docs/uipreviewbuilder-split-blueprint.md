<!-- doc_id: doc_tech_0019 -->
# `UIPreviewBuilder.ts` 拆分藍圖

本文件只描述 `UIPreviewBuilder.ts` 的拆分方向。通用的高風險檔、單寫者與 400 行硬規則，統一以 [keep.md](./keep.md (doc_index_0011)) (doc_index_0011) 為準。
...
- 單寫者規則依 [keep.md](./keep.md (doc_index_0011)) (doc_index_0011)
- 每次拆分只處理單一責任
- 先搬移，不先改行為
- 新檔一律納入 UTF-8 防災檢查
