...
- `agent1-instructions.md`、`agent2-instructions.md`
  - 各 Agent 的角色、責任與目前任務摘要。
- `tasks/`
  - 每張任務卡一個 Markdown 檔。
- [tasks_index.md](C:\Users\User\3KLife\docs\agent-briefs\tasks_index.md)
  - 任務索引。
- [CheckList.md](C:\Users\User\3KLife\docs\agent-briefs\CheckList.md)
  - 任務總表與依賴摘要。
...
1. 先讀 [keep.md](C:\Users\User\3KLife\docs\keep.md)。
...
1. 在 `docs/agent-briefs/tasks/` 新增任務卡。
2. 指派唯一 ID、owner、priority、status、related、depends。
